export const DiagnosticCode = {
  ...
  IMPORT_RESOLUTION_AMBIGUOUS: "IMPORT_RESOLUTION_AMBIGUOUS",
  TSCONFIG_PARSE_FAILED: "TSCONFIG_PARSE_FAILED",
  TSCONFIG_PATH_INVALID: "TSCONFIG_PATH_INVALID",
  WORKSPACE_MANIFEST_PARSE_FAILED: "WORKSPACE_MANIFEST_PARSE_FAILED",
} as const;
